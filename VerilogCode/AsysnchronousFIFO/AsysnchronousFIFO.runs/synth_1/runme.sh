...
HD_PWD='C:/Users/OAkun/Documents/GitHub/Asynchronous-FIFO/VerilogCode/AsysnchronousFIFO/AsysnchronousFIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AsynchronousFIFOTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AsynchronousFIFOTop.tcl
