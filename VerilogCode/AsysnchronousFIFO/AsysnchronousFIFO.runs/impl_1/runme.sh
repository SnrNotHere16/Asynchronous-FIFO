...
HD_PWD='C:/Users/OAkun/Documents/GitHub/Asynchronous-FIFO/VerilogCode/AsysnchronousFIFO/AsysnchronousFIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AsynchronousFIFOTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AsynchronousFIFOTop.tcl -notrace
